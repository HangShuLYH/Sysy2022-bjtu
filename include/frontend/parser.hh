...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    union union_type
    {
      ...
      // BlockItem
      char dummy3[sizeof (BlockItem*)];

      // BlockItemList
      char dummy4[sizeof (BlockItemList*)];

      // Begin
      // CompUnit
      char dummy5[sizeof (CompUnit*)];

      // Cond
      char dummy6[sizeof (Cond*)];
      ...
      // ConstDefList
      char dummy9[sizeof (ConstDefList*)];

      // ConstExp
      char dummy10[sizeof (ConstExp*)];

      // ConstExpList
      char dummy11[sizeof (ConstExpList*)];

      // ConstInitVal
      char dummy12[sizeof (ConstInitVal*)];

      // ConstInitValList
      char dummy13[sizeof (ConstInitValList*)];

      // DeclDef
      char dummy14[sizeof (DeclDef*)];

      // DefType
      char dummy15[sizeof (DefType*)];

      // EqExp
      char dummy16[sizeof (EqExp*)];

      // Exp
      char dummy17[sizeof (Exp*)];

      // FuncDef
      char dummy18[sizeof (FuncDef*)];

      // FuncFParam
      char dummy19[sizeof (FuncFParam*)];

      // FuncFParams
      char dummy20[sizeof (FuncFParams*)];

      // FuncRParams
      char dummy21[sizeof (FuncRParams*)];

      // InitVal
      char dummy22[sizeof (InitVal*)];

      // InitValList
      char dummy23[sizeof (InitValList*)];

      // LAndExp
      char dummy24[sizeof (LAndExp*)];

      // LOrExp
      char dummy25[sizeof (LOrExp*)];

      // LVal
      char dummy26[sizeof (LVal*)];

      // MulExp
      char dummy27[sizeof (MulExp*)];

      // Number
      char dummy28[sizeof (Number*)];

      // ParamArrayExpList
      char dummy29[sizeof (ParamArrayExpList*)];

      // PrimaryExp
      char dummy30[sizeof (PrimaryExp*)];

      // RelExp
      char dummy31[sizeof (RelExp*)];

      // Stmt
      char dummy32[sizeof (Stmt*)];

      // UnaryExp
      char dummy33[sizeof (UnaryExp*)];

      // UnaryOp
      char dummy34[sizeof (UnaryOp*)];

      // VarDecl
      char dummy35[sizeof (VarDecl*)];

      // VarDef
      char dummy36[sizeof (VarDef*)];

      // VarDefList
      char dummy37[sizeof (VarDefList*)];

      // FLOATCONST
      char dummy38[sizeof (float)];

      // INTCONST
      char dummy39[sizeof (int)];
